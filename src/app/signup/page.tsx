  ...
  <Image src={login_logo} alt="login" className="text-white mx-auto mb-0 w-[140px] h-[46px] "/>
       ...
       <div className='flex justify-center m-auto  w-[535px] h-[645px] mt-5 signin'>
         ...
         <div className='border  w-[520px] h-[607px] mt-0'>
            ...
            <h1 className=" pt-8 pb-2 font-medium text-[26px] ">Create your account</h1>
           <h6 className="text-sm text-[#808080]">Already have and account?<Link href={"/signin"}><span className="font-bold text-red-600 hover:underline cursor-pointer"> Sign in</span></Link> </h6>
            </div>
            <form action="" className="pt-11">
              <div className="w-[440px] h-[82px]  m-auto">
              <label className="block font-normal text-sm py-3 text[#1F1B2D]">Full Name</label>
              <input type="text"  name="email" placeholder="Sana Ullah" className="cursor-pointer  w-[440px] h-[54px] border rounded-sm px-4 text-sm focus:outline-none focus:border-2 focus:border-blue-500" />
              </div>
              ...
              <div className="w-[440px] h-[82px]  m-auto ">
              <Link href={"/signin"}>
              <button className="bg-[#04AA77] w-full h-[54px] text-white uppercase text-xs font-semibold hover:opacity-70 duration-500">Create an account</button>
              </Link>
              </div>
            </form>
         </div>
