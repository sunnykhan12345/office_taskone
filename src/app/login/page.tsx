...
const LoginPage = () => {
  return (
    <>
      ...
      <Image src={login_logo} alt="login" className="mx-auto mt-10 mb-0 w-[140px] h-[46px]"/>
         <div className='flex justify-center m-auto  w-[535px] h-[645px] mt-5'>
          
           <div className='border  w-[520px] h-[607px] mt-0'>
              <div className="text-center">
              <h1 className=" pt-8 pb-2 font-medium text-[26px] ">Sign In</h1>
             <h6 className="text-sm text-[#808080]">Don't have an account yet?<Link href={"/signup"}><span className="font-bold text-red-600 hover:underline cursor-pointer">Sign up</span> </Link></h6>
              </div>
